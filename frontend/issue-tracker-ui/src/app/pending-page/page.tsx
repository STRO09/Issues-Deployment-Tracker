...
export function PendingRolePage({ user }: PendingRolePageProps) {
  ...
  const [submitSuccess, setSubmitSuccess] = useState(false)
    ...
    },
    {
      ...
      description: "Can manage projects, assign issues, and deploy applications",
    }
    ]
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-balance">Welcome, {user.username}!</h1>
          <p className="text-lg text-muted-foreground mt-2 text-pretty">
            Your role is not assigned yet. Please request a role to access the system.
          </p>
        </div>
      </div>
      ...
      {submitSuccess && (
        <Alert className="border-green-500/20 bg-green-500/10">
          ...
          <AlertDescription className="text-green-700">
            Your role request has been submitted successfully! An admin will review it soon.
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Choose the role that best matches your responsibilities and provide a reason for your request.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <label className="text-sm font-medium">Requested Role</label>
              <Select value={requestedRole} onValueChange={(value) => setRequestedRole(value as Role)}>
                <SelectTrigger>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Choose your role and provide a reason</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Once approved, you can access all features</p>
              </div>
            </div>
          </div>
        </CardContent>
